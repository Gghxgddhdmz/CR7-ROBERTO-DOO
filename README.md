...
local Section = Tab:AddSection({
	Name = " ولك يهيثم يزبال كسمك "
})

Tab:AddButton({
	Name = "سكربت تحكم منظور اللاعب",
	Callback = function()
...
Tab:AddColorpicker({
	Name = "Colorpicker",
	Default = Color3.fromRGB(255, 189, 189),
